...
public class ExcelTests {
	...
	public void testLoadXSSWorkbookResource() throws Exception {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("xlsx", new ContentsHandlingResourceFactory(capabilityLoader, progressMonitor));
	...
	public void testLoadCSVResource() throws Exception {
		...
		CapabilityLoader capabilityLoader = new CapabilityLoader();
		ProgressMonitor progressMonitor = new PrintStreamProgressMonitor();
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put("csv", new ContentsHandlingResourceFactory(capabilityLoader, progressMonitor));
